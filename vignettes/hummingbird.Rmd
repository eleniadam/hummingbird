...
and "2" denotes a predicted hypomethylated bin.
...
"1" indicates predicted hyper-methylation, and "2" indicates predicted 
...
group and the normal group for each bin. Numbers ("0", "1", "2") indicate the 
predictions.
